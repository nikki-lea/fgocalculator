...
export const AppActions = {
  ...
  setTicketSQ: createActionPayload<typeof SET_CURRENT_TICKETS, number>(SET_CURRENT_TICKETS),
  ...
  setShopTickets: createActionPayload<typeof SET_MONTHLY_SHOP_TICKETS, number>(SET_MONTHLY_SHOP_TICKETS),
  ...
  switch (action.type) {
    case SET_CURRENT_SQ:
      ...
      case HANDLE_FORM_SUBMIT:
        ...
        const shopTicketSQ = calcShopTicketSQ({startDate: state.startDate, endDate: state.endDate, monthlyShopTickets: state.monthlyShopTickets});
