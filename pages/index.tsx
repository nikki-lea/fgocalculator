    ...
    return (
      <div className="current-container">
        ...
        <div className="form-column">
            ...
            <div><FormControlLabel control={<StyledCheckbox onChangeHandler={(e) => {dispatch({type: "REMOVE_TICKETS_FROM_SQ", value: {removeTicketsFromSQ: e.target.checked}})}} />} label={t("ticketassq")}/></div>
          </div>
          <div className="form-column">
