      ...
      <div className="current-container">
        ...
        <div className="currency-form">
          <div className="form-column">
            <TextField id="outlined-basic" inputProps={{type: "number"}} label={t("current.sq")} variant="outlined" color="info" fullWidth onBlur={(e) => {dispatch({type: "SET_CURRENT_SQ", value: {currentSQ: parseInt(e.target.value)}})}}/>
